...
/**
 * Generic base controller with common utilities for all controllers in User service.
 */
public abstract class BaseController {
    ...
    protected <T> ResponseEntity<T> notFound(T message) {
        logger.warn("Response 404 Not Found - message: {}", message);
